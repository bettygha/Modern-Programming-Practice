...
public class DepartmentApplication {
	...
	public static void main(String[] args) throws IOException
	      ...
	      Department dept = new Department("ComputerScience");
	        ...
	        Person frankMoore = new Faculty("Frank Moore","472-5921",43,10000,DemoEnum.MALE);	
			Person samHoward = new Faculty("Sam Howard","472-7222",55,9500,DemoEnum.FEMALE);
			Person johnDoodle = new Faculty("John Doodle","472-6190",39,8600,DemoEnum.MALE);
			...
			// Create student objects
						Person johnDoe = new Student("John Doe","472-1121",22,4.0,DemoEnum.MALE);
						Person maryJones = new Student("Mary Jones","472-7322",32,3.80,DemoEnum.FEMALE);
						Person leeJohnson = new Student("Lee Johnson","472-6009",19,3.65,DemoEnum.FEMALE);
						...
						Person frankGore = new Staff("Frank Gore","472-3321",33,4050,DemoEnum.MALE);
						Person adamDavis = new Staff("Adam Davis","472-7552",50,5500,DemoEnum.MALE);
						Person davidHeck = new Staff("David Heck","472-8890",29,3600,DemoEnum.MALE);
	      ...
	      //  create the objects that you need.
						...
						Person staff1 = new StaffStudent("Abebe Beso", "0932505552", 30, 1000, 4.0,DemoEnum.MALE);
						dept.addPerson(staff1);
	...
	However, this mistake below does show us How we could implement the code IF it was two-directional!  */
	      ...
	      while(true)
	         ...
	         putText("getTotalSalary, showAllMembers, unitsPerFaculty  FucultyStudent or quit : ");
	         int choice = getChar();
	         switch(choice)
	            {
	            case 'g':
	            ...
	            case 'f':
	            	...
	            	System.out.println("Please enter a faculty name to get the list of students who also takes the course of the faculty teaches ");
	            	Scanner scanner = new Scanner(System.in);
	            	String holdString = scanner.nextLine();
	            	HashSet<String> listOfStudents = new HashSet<>();
	            	listOfStudents= dept.getfacultyStudents(holdString);
	            	Iterator<String> iterator =listOfStudents.iterator();
	            	if(listOfStudents.isEmpty()) {
	            		System.out.println("No Students in this faculty, Please try again next time !!!"
	            				+ "");
	            	}
	            	else {
